...
internal static unsafe class DialogDriver
{
    ...
    private const string SelectStringThrottleKey = "ASL.Dialog.SelectString";
    private const string SelectYesnoThrottleKey = "ASL.Dialog.SelectYesno";
    private const string TalkThrottleKey = "ASL.Dialog.Talk";
