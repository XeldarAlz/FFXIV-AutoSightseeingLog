...
internal static class L
{
    ...
    {
        public static readonly LocString CommandHelp = new("plugin.commandHelp", "Toggle the Auto Sightseeing Log window. /asl config | stats | deps | about | console (open the plugin console) | changelog (open the changelog) | pause (pause or resume the run) | goto <number> (travel to a vista without logging it; goto stop cancels) | logdump (write the Sightseeing Log state to the plugin log).");
