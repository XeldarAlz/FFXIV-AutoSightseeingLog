...
internal sealed class AutoReturnToInn : AutoCommon
{
    ...
    protected override async Task Execute()
    {
        ...
        Svc.Chat.Print($"{AslConstants.LogPrefix} Tour complete. Retiring to the inn in {cityName}.");
        ...
        try
        {
            ...
            {
                Warn($"Return to inn: could not reach {cityName}; staying where the tour ended.");
                return;
            }
