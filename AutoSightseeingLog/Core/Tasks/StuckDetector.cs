...
internal static class StuckDetector
{
    ...
    internal static Func<bool> MoveStallAbort(string label)
    {
        ...
        return () =>
        {
            ...
            Svc.Log.Info($"{AslConstants.LogPrefix} {label} stalled ({kind}); aborting the move");
            return true;
        };
    }
    ...
    internal static Func<bool> AirborneFreezeAbort(string label)
    {
        ...
        return () =>
        {
            ...
            Svc.Log.Info($"{AslConstants.LogPrefix} {label} froze in the air for {AirborneFreezeMs}ms at {position}; aborting the descent");
            return true;
        };
    }
}
