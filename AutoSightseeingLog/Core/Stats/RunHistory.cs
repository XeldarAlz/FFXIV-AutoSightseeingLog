...
internal sealed class RunHistory
{
    ...
    private void Load()
    {
        ...
        {
            Svc.Log.Warning(exception, $"{AslConstants.LogPrefix} RunHistory load failed; starting empty");
        }
    }
    ...
    private void RecomputeLifetime()
    {
        ...
        for (var index = 0; index < Records.Count; index++)
        {
            ...
            totals.Vistas += record.VistasLogged;
            totals.Zones += record.ZonesVisited;
    ...
    private void Save()
    {
        ...
        {
            Svc.Log.Warning(exception, $"{AslConstants.LogPrefix} RunHistory save failed");
        }
    }
    ...
    public struct LifetimeTotals
    {
        ...
        public readonly double VistasPerHour => Seconds > 0 ? Vistas / (Seconds / 3600.0) : 0;
