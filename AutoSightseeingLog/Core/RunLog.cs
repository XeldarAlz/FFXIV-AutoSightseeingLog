...
// console instead of digging the [ASL] lines out of dalamud.log. IPC callbacks and file loads log
...
public static class RunLog
{
    ...
    {
        Svc.Log.Warning(exception, $"{AslConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error($"{AslConstants.LogPrefix} {message}");
    ...
    {
        Svc.Log.Error(exception, $"{AslConstants.LogPrefix} {message}");
