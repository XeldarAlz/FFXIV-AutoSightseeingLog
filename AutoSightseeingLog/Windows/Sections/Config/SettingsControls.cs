...
internal static class SettingsControls
{
    ...
    public static void DrawLanguageCombo(Configuration cfg, float width = RowComboWidth)
    {
        ...
        if (Dropdown.Draw("##asl_language", languageLabels, ref selected, width))
        {
    ...
    public static IDisposable PushFrameColors()
        => ImRaii.PushColor(ImGuiCol.SliderGrab, Styling.AccentStar)
            .Push(ImGuiCol.SliderGrabActive, Styling.AccentStarSoft)
